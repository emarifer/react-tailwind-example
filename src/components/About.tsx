      ...
      <div className="max-w-[1240px] mx-auto px-4 py-16">
        <div>
          ...
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* Cards */}
            <AboutCard
              icon={(<SiHiveBlockchain size={40} />) as ReactNode}
              heading="Reliable, tamper-proof network"
              text="Use decentralization, trusted nodes, premium data, and cryptographic proofs to connect highly accurate and available
        data/APIs to any smart contract."
            />
            <AboutCard
              icon={(<SiFsecure size={40} />) as ReactNode}
            ...
            />
            <AboutCard
              icon={(<SiStrapi size={40} />) as ReactNode}
            ...
            />
            <AboutCard
              icon={(<VscServerProcess size={40} />) as ReactNode}
